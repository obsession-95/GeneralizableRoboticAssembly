...
class Search_Env():
    ...
    def step(self, action=None, isProcess=False, isCombination=False):
        ...
        # if (tcp_pos[2] < self.initial_pz - 1e-3) or (np.linalg.norm(area, ord=np.inf) < 0.15):
        ...
        for _ in range(10):
            ...
            for i in range(50):
                ...
                if SIM:
                    ...
                    img_x, img_y = self.real_rob.getVisionImage()
    ...
    def _reset(self, err_theta=math.pi, err_r=3e-3, isRegular=False):
        ...
        if SIM:
            ...
            initial_pos[2] -= (relative_pos[2] - uniform(0, 3e-4))
            self.real_rob.setPosOrt(initial_pos)
        ...
        while True:
            ...
            if SIM:
                ...
                self.real_rob.setPosOrt(initial_pos, speed=0.5, acc=0.25, asynchronous=True, isSoft=True)
